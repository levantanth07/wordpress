...
<!--    <link href="--><?//=bloginfo('template_url')?><!--/assets/v2.3/desktop/css/icon-font.css?v=--><?//=\GDelivery\Libs\Config::VERSION?><!--" rel="stylesheet">-->
    ...
    <link href="<?=bloginfo('template_url')?>/assets/js/select2/select2.css" rel="stylesheet" />
    <script src="<?=bloginfo('template_url')?>/assets/js/select2/select2.js"></script>
    ...
    <nav class="navbar navbar-expand-md fixed-top  ">
        ...
        <ul class="navbar-nav menu">
            <?php if (isset($args['user']) && ($args['user']->role == 'operator' || $args['user']->role == 'administrator')) :?>
                ...
                <li class="<?=strpos($currentUrl, 'manage-complain') ? 'active' : ''?>">
                    <a href="<?=site_url('manage-complain')?>">Quản lý khiếu nại</a>
                </li>
            <?php endif; ?>
